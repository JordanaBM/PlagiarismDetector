...
#define F 55
int main () {
    double a1,a2,a3,a4,a5,b1,b2,b3,b4,b5,m1,m2,m3,m4,m5,T,M,B;
scanf ("%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", &a1,&a2,&a3,&a4,&a5,&b1,&b2,&b3,&b4,&b5,&m1,&m2,&m3,&m4,&m5);
